...
export class PackageController {
    findAll() {
        ...
        const handler = async (req, res) => {
            packageDao.findAll(req.query.page, req.query.size, req.query.id).then(result => {
                if (result.status) {
    ...
    findOne() {
        ...
        const handler = async (req, res) => {
            packageDao.findOne(req.params.id).then(result => {
                if (result.status) {
                    res.json(response.success(result.result))
                } else {
                    res.json(response.fail(result.message))
    ...
    create() {
        ...
        const handler = async (req, res) => {
            ...
            packageDao.create(name, content).then(result => {
                if (result.status) {
                    res.json(response.success(result.result))
                } else {
                    res.json(response.fail(result.message))
    ...
    update() {
        ...
        const handler = async (req, res) => {
            ...
            packageDao.update(id, name, content).then(result => {
                if (result.status) {
                    res.json(response.success(result.result))
                } else {
                    res.json(response.fail(result.message))
    ...
    remove() {
        ...
        const handler = async (req, res) => {
            const { id } = req.body
            packageDao.remove(id).then(result => {
                if (result.status) {
                    res.json(response.success(result.result))
                } else {
                    res.json(response.fail(result.message))
